		...
		do
		{
			...
			if(logindao.validate(login))
			{
				...
				do
				{
					...
					System.out.println("Enter the minselling quanity:");
			...
			else
			{
				...
				System.out.println("Check your Usename & Password");
				
			}
			break;
			
			case 2: System.out.println("_____________________________________________________________");
			System.out.println("Enter the Username");
